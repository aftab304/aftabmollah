  ...
  return (
    <section id="audience" className="mx-auto max-w-7xl px-6 pt-8 pb-20 scroll-mt-24">
      <SectionHeader
        ...
        title={
          <>
            The short version, for anyone <span className="text-gradient italic">who wants it</span>
            .
          </>
        }
      ...
      >
        ...
        <h3 className="relative font-display text-3xl md:text-5xl leading-tight text-center text-balance max-w-3xl mx-auto">
          I quantify how <span className="text-gradient italic">biology makes decisions</span> at
          the molecular level.
        </h3>
