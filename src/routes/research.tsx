...
const themes = [
  {
    ...
    problem:
      "N6-methyladenosine (m6A) is the most abundant internal mRNA modification, yet how reader proteins selectively recognize it within DRACH motifs is still being decoded.",
    matters:
      "Reader recognition controls mRNA stability, localization, and translation — directly tied to development, cancer, and immune responses.",
    approach:
      "I identify and characterize candidate readers like hnRNP A1 using ITC, fluorescence binding assays, and structural biology.",
    relevance:
      "Disease relevance: m6A dysregulation is implicated in AML, glioblastoma, and neurological disorders — our work identifies the molecular basis of selective recognition.",
  ...
  },
  {
    ...
    problem:
      "Specificity in RNA–protein interactions emerges from a subtle balance of shape, charge, and sequence context.",
    matters:
      "Quantifying that balance is the first step toward engineering RNA-targeting therapeutics and diagnostic probes.",
    approach:
      "I combine systematic mutagenesis with quantitative biophysics — thermodynamic fingerprints reveal what binding really costs.",
    relevance:
      "Disease relevance: Disrupted RNA-protein recognition underlies aberrant splicing and translation in cancer and CNS disease.",
  ...
  },
  {
    ...
    problem:
      "Many candidate RNA-binding proteins lack a quantitative description of their binding modes.",
    matters:
      "Without rigorous thermodynamics and kinetics, mechanistic hypotheses remain just hypotheses.",
    approach:
      "ITC for thermodynamics, fluorescence for kinetics and conformational change, EMSA for selectivity — used together they form a complete picture.",
    relevance:
      "Disease relevance: Quantifying binding thermodynamics provides the mechanistic foundation for RNA-targeted drug discovery.",
    accent: "from-[var(--azure)] to-[var(--cyan)]",
    pubIds: [],
  ...
  },
  {
    ...
    matters:
      "Bridging these scales lets us tie thermodynamic affinity to where and when binding happens in living systems.",
    approach:
      "Confocal fluorescence microscopy on labeled biomolecules connects in-cell observations with in vitro biophysics.",
    relevance:
      "Disease relevance: Cell-based imaging of RNA-protein co-localization supports target engagement studies relevant to therapeutic development.",
    accent: "from-[var(--cyan)] to-[var(--azure)]",
    pubIds: [],
  ...
  return (
    <section id="research" ref={ref} className="mx-auto max-w-7xl px-6 pt-8 pb-20 scroll-mt-24">
      <SectionHeader
        ...
        title={
          <>
            The science I <span className="text-gradient italic">live in</span>.
          </>
        }
      ...
      <div className="mt-16 grid gap-8">
        {themes.map((t, i) => (
          ...
          >
            <div
              className={`absolute -top-32 -right-32 h-72 w-72 rounded-full bg-gradient-to-br ${t.accent} opacity-30 blur-3xl pointer-events-none`}
            />
            <div className="grid md:grid-cols-[260px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 items-start">
                ...
                <div className="glass rounded-2xl p-2 relative overflow-hidden">
                  <div className="relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-[var(--accent)]/40 to-transparent">
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between text-[9px] uppercase tracking-[0.2em]">
                      <span className="bg-background/80 backdrop-blur rounded-full px-2 py-1 text-foreground/80">
                        Graphical abstract
                      </span>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="mt-6 space-y-5">
                  <div>
                    <p className="text-xs uppercase tracking-[0.18em] text-[var(--azure)]">
                      The problem
                    </p>
      ...
      <div className="mt-14 text-center">
        <a
          href="#publications"
          className="inline-flex items-center gap-2 glass rounded-full px-5 py-3 text-sm font-medium hover:shadow-glow"
        >
