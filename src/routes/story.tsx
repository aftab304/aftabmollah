...
const chapters: Chapter[] = [
  {
    ...
    body: "I grew up in West Bengal, India, the kind of place where small questions about the natural world quickly turn into big curiosities. Chemistry was the language that first made the invisible feel real to me.",
  ...
  },
  {
    ...
    body: "I left for the United States alone, carrying two suitcases and a fully funded PhD position at Kent State University. The first months were equal parts intimidation and exhilaration — a new country, a new lab, and a new way of working.",
  ...
  },
  {
    ...
    body: "My doctoral work centers on RNA–protein interactions and m6A reader proteins — the molecules that decide which messages in our cells get read, and how. Biophysics gave me a way to ask thermodynamic questions about biology and actually answer them.",
  ...
  },
  {
    ...
    body: "Mentoring undergraduates and participating in STEM outreach reshaped what success looks like for me. Some of my proudest moments have been watching mentees win their own awards at the Ohio Academy of Science and the ACS Honors Week.",
  ...
  },
  {
    ...
    body: "I want to keep working at the interface of biophysics and biomedicine — where mechanistic insight into RNA–protein recognition becomes leverage for new diagnostics, modulators, and therapies. Academic or industry, the question is the same: how do we read the molecular language well enough to rewrite it for human good?",
  ...
  return (
    <section id="story" ref={ref} className="mx-auto max-w-6xl px-6 pt-8 pb-20 scroll-mt-24">
      <SectionHeader
        ...
        title={
          <>
            A journey through <span className="text-gradient italic">molecules</span>.
          </>
        }
              ...
              >
                <div className={`${left ? "md:text-right md:pr-12" : "md:pl-12"}`}>
                  <div className="inline-flex items-center gap-2 glass rounded-full px-3 py-1 text-xs uppercase tracking-[0.18em] text-muted-foreground">
                    <span className="h-1.5 w-1.5 rounded-full bg-[var(--azure)]" /> {c.tag} ·{" "}
                    {c.year}
                  </div>
                  ...
                  <div className="glass rounded-3xl p-3 relative overflow-hidden">
                    ...
                    <div className="relative aspect-square rounded-2xl overflow-hidden">
                      ...
                      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-[10px] uppercase tracking-[0.18em] text-foreground/90">
                        <span className="bg-background/70 backdrop-blur rounded-full px-2.5 py-1">
                          Chapter {i + 1}
                        </span>
                        <span className="bg-background/70 backdrop-blur rounded-full px-2.5 py-1">
                          {c.year}
